...
class SearchAdapter : RecyclerView.Adapter<SearchAdapter.SearchViewHolder>() {
    ...
    inner class SearchViewHolder(val binding: RowSearchUserBinding) :
        RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SearchViewHolder {
        val binding =
            RowSearchUserBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    override fun onBindViewHolder(holder: SearchViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val action =
                SearchFragmentDirections.actionSearchFragmentToUserProfileFragment(user.userId.toString())
